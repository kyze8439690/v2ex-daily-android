 ...
 */
public class BaseTopicsRequest extends Request<Topic[]> {

    private Response.Listener<Topic[]> mListener;

    public BaseTopicsRequest(String url, Response.Listener<Topic[]> listener, Response.ErrorListener errorListener) {
