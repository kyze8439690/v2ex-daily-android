 ...
 */
public class NewestTopicsFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {

    @InjectView(R.id.swipe_refresh_layout) SwipeRefreshLayout mRefreshLayout;
    @InjectView(R.id.recycler_view) RecyclerView mRecyclerView;

    private NewestTopicsDataHelper mDataHelper;
    ...
    private void getData() {
        ...
        RequestManager.getInstance().getNewestTopics(this, new Response.Listener<Topic[]>() {
            @Override
